...
export function IconClipboardList({ size = 18, color = 'currentColor', className = '', style = {} }) {
  return (
    <svg 
      width={size} 
      height={size} 
...
export const ClipboardListIcon = IconClipboardList;

export function IconChevronDown({ size = 18, color = 'currentColor', className = '', style = {} }) {
  return (
    <svg 
      width={size} 
      height={size} 
