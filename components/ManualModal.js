...
export default function ManualModal({ isOpen, onClose, initialTab = 'user' }) {
  ...
  return (
    <div style={{
      ...
      <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <div>
              <h2 style={{ margin: 0, fontSize: '17px', fontWeight: 800, color: 'var(--navy)', display: 'flex', alignItems: 'center', gap: '6px' }}>
                📖 Tennis Match 서비스 이용 매뉴얼
              </h2>
              <p style={{ margin: 0, fontSize: '11px', color: 'var(--txt3)' }}>
                테친회 공식 사용자 & 운영자 통합 가이드
              </p>
            </div>
          </div>
          <button 
        ...
        {/* Tab & Control Toolbar (전체 펼치기 / 모으기 & 검색) */}
        <div style={{
          padding: '10px 20px',
          borderBottom: '1px solid #e2e8f0',
          display: 'flex',
          ...
          {/* Expand/Collapse All Buttons & Search */}
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
            ...
            <input
              ...
              placeholder="🔍 매뉴얼 검색..."
              style={{ width: '180px', fontSize: '12px', padding: '5px 8px', height: '28px' }}
              value={searchQuery}
        ...
        {/* Content Body - with minHeight: 0 and full scrolling without item shrinkage */}
        <div style={{
          ...
          {activeTab === 'user' && (
            <>
              ...
              <div style={{ border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden', boxShadow: '0 1px 3px rgba(0,0,0,0.02)', flexShrink: 0 }}>
                <div 
                  style={{ 
                    padding: '12px 16px', 
                ...
                >
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                    ...
                    <span style={{ fontSize: '12px' }}>{openSections['user-pwa'] ? '▲' : '▼'}</span>
                  </div>
                </div>
                {openSections['user-pwa'] && (
                  <div style={{ padding: '16px 18px', backgroundColor: '#fff', display: 'flex', flexDirection: 'column', gap: '10px', borderTop: '1px solid #dcfce7' }}>
                    <p style={{ margin: 0 }}>
                      스마트폰 브라우저에서 접속 후 홈 화면에 추가하면 <strong>테친회 공식 캐릭터 로고 아이콘</strong>이 생성되며, 주소창 없이 앱처럼 편리하게 이용할 수 있습니다.
                    </p>
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '10px' }}>
                      <div style={{ padding: '12px 14px', backgroundColor: '#f8fafc', borderRadius: '8px', border: '1px solid #e2e8f0' }}>
                        <strong style={{ color: '#0369a1' }}>🍎 아이폰 (Safari)</strong>
                        <ol style={{ paddingLeft: '18px', margin: '6px 0 0 0', fontSize: '12px', display: 'flex', flexDirection: 'column', gap: '3px' }}>
                          <li>사파리 브라우저로 <strong>tcmngr.vercel.app</strong> 접속</li>
                          <li>하단 중앙의 <strong>공유 버튼(네모+화살표)</strong> 터치</li>
                          <li>메뉴에서 <strong>[홈 화면에 추가]</strong> 터치</li>
                          <li>우측 상단 <strong>[추가]</strong> 터치 완료</li>
                        </ol>
                      </div>
                      <div style={{ padding: '12px 14px', backgroundColor: '#f8fafc', borderRadius: '8px', border: '1px solid #e2e8f0' }}>
                        <strong style={{ color: '#15803d' }}>🤖 안드로이드 (Chrome/삼성인터넷)</strong>
                        <ol style={{ paddingLeft: '18px', margin: '6px 0 0 0', fontSize: '12px', display: 'flex', flexDirection: 'column', gap: '3px' }}>
              ...
              <div style={{ border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden', boxShadow: '0 1px 3px rgba(0,0,0,0.02)', flexShrink: 0 }}>
                ...
                >
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                    ...
                    <span style={{ fontSize: '12px' }}>{openSections['user-dashboard'] ? '▲' : '▼'}</span>
                  </div>
                </div>
                {openSections['user-dashboard'] && (
                  <div style={{ padding: '16px 18px', backgroundColor: '#fff', display: 'flex', flexDirection: 'column', gap: '8px', borderTop: '1px solid #dbeafe' }}>
              ...
              <div style={{ border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden', boxShadow: '0 1px 3px rgba(0,0,0,0.02)', flexShrink: 0 }}>
                ...
                >
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                    ...
                    <span style={{ fontSize: '12px' }}>{openSections['user-votes'] ? '▲' : '▼'}</span>
                  </div>
                </div>
                {openSections['user-votes'] && (
                  <div style={{ padding: '16px 18px', backgroundColor: '#fff', display: 'flex', flexDirection: 'column', gap: '8px', borderTop: '1px solid #fef08a' }}>
              ...
              <div style={{ border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden', boxShadow: '0 1px 3px rgba(0,0,0,0.02)', flexShrink: 0 }}>
                ...
                >
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                    ...
                    <span style={{ fontSize: '12px' }}>{openSections['user-tournaments'] ? '▲' : '▼'}</span>
                  </div>
                </div>
                {openSections['user-tournaments'] && (
                  <div style={{ padding: '16px 18px', backgroundColor: '#fff', display: 'flex', flexDirection: 'column', gap: '10px', borderTop: '1px solid #f3e8ff' }}>
                    <div>
              ...
              <div style={{ border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden', boxShadow: '0 1px 3px rgba(0,0,0,0.02)', flexShrink: 0 }}>
                ...
                >
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                    <span style={{ fontSize: '11px', color: 'var(--txt3)', fontWeight: 600 }}>
                      {openSections['user-stats'] ? '접기' : '펼치기'}
                    </span>
                    <span style={{ fontSize: '12px' }}>{openSections['user-stats'] ? '▲' : '▼'}</span>
                  </div>
                </div>
                {openSections['user-stats'] && (
                  <div style={{ padding: '16px 18px', backgroundColor: '#fff', display: 'flex', flexDirection: 'column', gap: '8px', borderTop: '1px solid #e2e8f0' }}>
              ...
              <div style={{ border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden', boxShadow: '0 1px 3px rgba(0,0,0,0.02)', flexShrink: 0 }}>
                ...
                >
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                    ...
                    <span style={{ fontSize: '12px' }}>{openSections['admin-login'] ? '▲' : '▼'}</span>
                  </div>
                </div>
              ...
              <div style={{ border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden', boxShadow: '0 1px 3px rgba(0,0,0,0.02)', flexShrink: 0 }}>
                ...
                >
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                    ...
                    <span style={{ fontSize: '12px' }}>{openSections['admin-create'] ? '▲' : '▼'}</span>
                  </div>
                </div>
                {openSections['admin-create'] && (
                  <div style={{ padding: '16px 18px', backgroundColor: '#fff', display: 'flex', flexDirection: 'column', gap: '10px', borderTop: '1px solid #dcfce7' }}>
                    ...
                    <div style={{ padding: '10px 12px', backgroundColor: '#f8fafc', borderRadius: '8px', border: '1px solid #e2e8f0', fontSize: '12px' }}>
              ...
              <div style={{ border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden', boxShadow: '0 1px 3px rgba(0,0,0,0.02)', flexShrink: 0 }}>
                ...
                >
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                    ...
                    <span style={{ fontSize: '12px' }}>{openSections['admin-editor'] ? '▲' : '▼'}</span>
                  </div>
                </div>
                {openSections['admin-editor'] && (
                  <div style={{ padding: '16px 18px', backgroundColor: '#fff', display: 'flex', flexDirection: 'column', gap: '8px', borderTop: '1px solid #fee2e2' }}>
              ...
              <div style={{ border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden', boxShadow: '0 1px 3px rgba(0,0,0,0.02)', flexShrink: 0 }}>
                ...
                >
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                    ...
                    <span style={{ fontSize: '12px' }}>{openSections['admin-tournaments'] ? '▲' : '▼'}</span>
                  </div>
                </div>
                {openSections['admin-tournaments'] && (
                  <div style={{ padding: '16px 18px', backgroundColor: '#fff', display: 'flex', flexDirection: 'column', gap: '12px', borderTop: '1px solid #f3e8ff' }}>
                    <div>
                      <strong style={{ color: '#7e22ce' }}>📍 1단계: 대회 기본 환경 설정</strong>
                      <ul style={{ paddingLeft: '20px', margin: '4px 0 0 0' }}>
                    ...
                    <div>
                      <strong style={{ color: '#7e22ce' }}>📍 2단계: 참석자 명단 및 코트 배정</strong>
                      <ul style={{ paddingLeft: '20px', margin: '4px 0 0 0' }}>
                    ...
                    <div>
                      <strong style={{ color: '#7e22ce' }}>📍 3단계: 팀원 배정 및 출전 명단 구성 (팀전)</strong>
                      <ul style={{ paddingLeft: '20px', margin: '4px 0 0 0' }}>
                    ...
                    <div>
                      <strong style={{ color: '#7e22ce' }}>📍 4단계: 대회 경기 진행 & 실시간 스코어보드</strong>
                      <ul style={{ paddingLeft: '20px', margin: '4px 0 0 0' }}>
              ...
              <div style={{ border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden', boxShadow: '0 1px 3px rgba(0,0,0,0.02)', flexShrink: 0 }}>
                ...
                >
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                    ...
                    <span style={{ fontSize: '12px' }}>{openSections['admin-members'] ? '▲' : '▼'}</span>
                  </div>
                </div>
